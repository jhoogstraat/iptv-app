...
- Background execution is intentionally not declared; stale catalogs refresh on foreground activation. Previously hydrated categories remain local and can be reconciled on demand after category refresh.
